        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Advanced appointment management with calendar view, scheduling,
              and reminders
            </p>
          </div>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              ...
                              <div className="text-right">
                                <div
                                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border mb-2 ${getStatusColor(
                                    apt.status
                                  )}`}
                                >
                                  {apt.status}
