              ...
              <Card className="p-8 text-center">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-gray-600 mb-6">
                    We're building advanced AI-powered health analytics to
                    provide you with personalized insights, trend analysis, and
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    Health trends analysis will show patterns in your health
                    data over time.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="p-6">
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    Comprehensive health summary reports generated by AI
                    analysis.
                  </p>
                </div>
              </CardContent>
